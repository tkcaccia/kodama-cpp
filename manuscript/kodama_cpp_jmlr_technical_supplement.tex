...
The public surface groups cross-validation, core optimization, graph preparation, matrix and graph-input KODAMA, PCA, visualization, and graph utilities. The installed C++ headers and generated R/Python references are the authoritative signature list.
