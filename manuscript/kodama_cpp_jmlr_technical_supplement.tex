...
\caption{Matched MetRef UMAP validation after the float32 PLS--LDA optimization. Classic data, CPU KODAMA, and CUDA KODAMA use exact $k=30$, the same original-data PCA initialization, seed, epochs, and CPU embedding implementation. Colors are external reference labels withheld from optimization.}
\end{figure}
